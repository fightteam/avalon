				...
				<fo:table-body>
					...
					<fo:table-row>
						<fo:table-cell text-align="center">
							...
							<fo:block font-family="simsun" font-size="14pt" padding="2mm">
					...
					<fo:table-row>
						<fo:table-cell text-align="center">
							<fo:block font-family="simsun" font-size="14pt" padding="5mm">
					...
					<fo:table-row>
						<fo:table-cell text-align="center">
							<fo:block font-family="simsun" font-size="10pt" padding="10mm">
							...
							<fo:block font-family="simsun" font-size="8pt" padding="1mm">
