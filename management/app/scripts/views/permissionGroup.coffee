...
#=================================================================================== 
	...
	class PermissionGroupView extends Backbone.View
		template: JST['app/scripts/templates/permissionGroup.ejs']

		dataTemplate: JST['app/scripts/templates/permissionGroup-data.ejs']
		...
		deleteData: (e)->
			...
			if not id
				return
			$.ajax
				url: config.rest.permissionGroups + "/" + id
				headers:
