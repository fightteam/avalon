...
#=================================================================================== 
	...
	class RoleView extends Backbone.View
		template: JST['app/scripts/templates/role.ejs']

		dataTemplate: JST['app/scripts/templates/role-data.ejs']
